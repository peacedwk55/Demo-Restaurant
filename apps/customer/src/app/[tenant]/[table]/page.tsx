  ...
  return (
    <main className="min-h-screen flex flex-col bg-white">
      ...
      <div className="px-5 -mt-6 relative z-10">
        <div className="bg-white rounded-3xl shadow-lg p-4 flex items-center gap-4 border border-stone-100">
      ...
      <div className="px-5 pb-12 pt-6 space-y-3">
        <Link
          ...
          className="flex items-center justify-center gap-2.5 w-full rounded-2xl font-extrabold text-lg text-white shadow-lg transition-all active:scale-95"
